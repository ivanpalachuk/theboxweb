...
const Mision = () => {
    ...
    return (
        <div
            className="mision-container h-screen bg-[url(/images/20230127_210906.jpg)] bg-cover bg-center w-full m-auto relative text-center flex justify-center items-center"
            onClick={toggleTextVisibility}
        >
            {!isTextVisible && (
                <div className="icon-container flex flex-col items-center mt-48">
                    <div className='mt-2 mb-8 font-custom1 bold text-l text-theboxyellow bg-black rounded-3xl uppercase border-2 border-current p-4'>Abri la caja!!!</div>
                    <BsFillBox2Fill size={75} className='text-theboxyellow animate-bounce relative text-center' />
                    <div className='mt-2 text-xl font-custom1 bold text-l text-theboxyellow bg-black rounded-3xl uppercase border-2 border-current p-4'>Conoce más sobre nosotros</div>
                </div>
            )}
